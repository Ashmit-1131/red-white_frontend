  ...
  return (
      ...
      <Box borderBottom="1px" borderColor="gray.200">
        ...
        <Flex justifyContent="space-between" padding={12}>
          <Box>
            <Link fontSize="xl" fontWeight="bold" color="blue.500" href="/blogs" marginRight="4">
              Blogs
            </Link>
          </Box>
          <Link fontSize="xl" fontWeight="bold" color="red.500" href="/login" marginRight="4">
            Login
          </Link>
          <Link fontSize="xl" fontWeight="bold" color="red.500" href="/signup" marginRight="4">
            Sign Up
          </Link>
          <Link fontSize="xl" fontWeight="bold" color="yellow.500" href="/profile">
            Profile
          </Link>
        </Flex>
      </Box>
